...
--conf_params "project,asv-skl2onnx;project_url,https://github.com/sdpython/asv-skl2onnx" 
--models SVR,RandomForestRegressor,DecisionTreeRegressor,AdaBoostRegressor,LinearRegression,KNeighborsRegressor,MLPRegressor -v 1 || exit 1
