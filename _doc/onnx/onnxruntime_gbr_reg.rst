...
.. index:: onnxruntime, GradientBoostingRegressor
...
.. runpython::
    ...
    import pandas
    name = os.path.join(__WD__, "../../onnx/results/bench_plot_onnxruntime_gbr.time.csv")
    df = pandas.read_csv(name)
...
:download:`bench_plot_onnxruntime_gbr.csv <../../onnx/results/bench_plot_onnxruntime_gbr.perf.csv>`
...
.. runpython::
    ...
    from pymlbenchmark.benchmark.bench_helper import bench_pivot
    import pandas
    name = os.path.join(__WD__, "../../onnx/results/bench_plot_onnxruntime_gbr.perf.csv")
    df = pandas.read_csv(name)
...
`bench_plot_onnxruntime_gbr.py <https://github.com/sdpython/_benchmarks/blob/master/onnx/bench_plot_onnxruntime_gbr.py>`_

.. literalinclude:: ../../onnx/bench_plot_onnxruntime_gbr.py
    :language: python
