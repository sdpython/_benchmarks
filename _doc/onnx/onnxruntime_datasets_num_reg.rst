...
.. runpython::
    ...
    import pandas
    name = os.path.join(__WD__, "../../onnx/results/bench_plot_datasets_num_reg.time.csv")
    df = pandas.read_csv(name)
...
.. runpython::
    ...
    import pandas
    name = os.path.join(__WD__, "../../onnx/results/bench_plot_datasets_num_reg.perf.csv")
    df = pandas.read_csv(name)
    print(df2rst(df, number_format=4))
...
`bench_plot_datasets_num.py <https://github.com/sdpython/_benchmarks/blob/master/onnx/bench_plot_datasets_num_reg.py>`_

.. literalinclude:: ../../onnx/bench_plot_datasets_num_reg.py
    :language: python
